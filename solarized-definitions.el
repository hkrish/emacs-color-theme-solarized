...
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ...
  '((base03  "#002b36" "#042028" "#1c1c1c" "brightblack"   "black")
    ...
    (yellow  "#b58d00" "#a57705" "#af8700" "yellow"        "yellow")
    (orange  "#bd5f00" "#bd3612" "#d75f00" "brightred"     "red")
    (red     "#e0332e" "#c60007" "#d70000" "red"           "red")
    (magenta "#d33982" "#c61b6e" "#af005f" "magenta"       "magenta")
    (violet  "#5c73c4" "#5859b7" "#5f5faf" "brightmagenta" "magenta")
    (blue    "#008dd1" "#2075c7" "#0087ff" "blue"          "blue")
    (cyan    "#1fa198" "#259185" "#00afaf" "cyan"          "cyan")
    (green   "#789d1c" "#728a05" "#5f8700" "green"         "green"))
